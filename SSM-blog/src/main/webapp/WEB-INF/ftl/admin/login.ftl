...
<body>
	...
	<form action="/admin/login.do" method="post" onsubmit="return checkForm()">
		<DIV
	...
	<div style="text-align:center;padding-top: 30px">Copyright © 2018song个人博客系统  版权所有  </div>
</body>
</html>